...
public class Prestamos extends JDialog implements ActionListener {
    ...
    public void componentes() {
        ...
        producto = img.getLabel("<html><strong>A nombre de</strong></html>", img.cr.AZUL, this, img.cr.MEDIUM);
        ...
        txtnombre.addKeyListener(new KeyAdapter() {
            ...
            private void txtnombreKeyTyped(KeyEvent evt) {
                img.cr.soloTexto(evt.getKeyChar(), evt, txtnombre.getText(), 25);
            }
        ...
        tiempo = img.getLabel("<html><strong>Tiempo</strong></html>", img.cr.AZUL, this, img.cr.MEDIUM);
        ...
        precio = img.getLabel("<html><strong>Préstamo de</strong></html>", img.cr.AZUL, this, img.cr.MEDIUM);
    ...
    public void btnPrestarAP() {
        ...
        if (refVal && telVal && docVal && preVal
            ...
            img.cr.setTotalPrestamo(Double.parseDouble(txtPrecio.getText()));

            // actualizar registradora
            String nom = "";

            try {
                nom = img.db.returnUser("Online");
            ...
            try {
                ...
                if (img.db.buscarUser(nom)) {
                    img.db.registrarPrestamos(nom, img.cr.getTotalPrestamo());
                } else {

                    String[] datos = {"registros", nom, String.valueOf(0), String.valueOf(0.0),
                            String.valueOf(0), String.valueOf(0.0),
                            String.valueOf(img.cr.getTotalPrestamo())};
            ...
            try {
                ...
                String[] datos = {"prestamos", img.db.returnUser("Online"), txtnombre.getText(), txtDoc.getText(),
            ...
            img.cr.setTotalPrestamo(Double.parseDouble(txtPrecio.getText()));
            img.cr.mostrarPrestamo(fechaFormat.format(fecha.getTime()), txtnombre.getText());
            img.cr.setTotalPrestamo(0);
            ...
            if (refVal && telVal && docVal && preVal) {
                JOptionPane.showMessageDialog(null, "<html>" + img.cr.styleJOption() + "<strong>Tiempo no definido</strong></html>", "Mensaje", JOptionPane.PLAIN_MESSAGE);
            }
        }
    }
