...
public class Phi extends JDialog implements ActionListener, MouseListener {
    ...
    public void componentes() {
        ...
        primero = h.getLabel("<html><strong>Serie de Fibonacci</strong></html>", h.appConfig.MAIN_COLOR, this, h.appConfig.MEDIUM);
        primero.setBounds(25, 70, 260, 30);

        forma1 = h.getLabel("<html><strong>Enésimo número de Fibonacci</strong></html>", h.appConfig.MAIN_COLOR, this, h.appConfig.MEDIUM);
        ...
        txt1.addKeyListener(new KeyAdapter() {
            ...
            private void txt1KeyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER && txt1.getText().length() > 0) {
                    h.appConfig.generarFibonacci(Integer.parseInt(txt1.getText()));
                    valor.setText(String.valueOf(h.appConfig.getPhi()) + " ...");
            ...
            private void txt1KeyTyped(KeyEvent e) {
                h.appConfig.solonumeros(e.getKeyChar(), e, txt1.getText(), 2);
            }
        });

        segundo = h.getLabel("<html><strong>Valor aproximado</strong></html>", h.appConfig.MAIN_COLOR, this, h.appConfig.MEDIUM);
        segundo.setBounds(25, 220, 260, 30);

        valor = h.getLabel("", h.appConfig.TEXT_COLOR, this, h.appConfig.MEDIUM);
        valor.setBounds(200, 220, 280, 30);

        forma2 = h.getLabel("<html><strong>Proporción áurea</strong></html>", h.appConfig.MAIN_COLOR, this, h.appConfig.MEDIUM);
        ...
        txt2.addKeyListener(new KeyAdapter() {
            ...
            private void txt2KeyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER && txt2.getText().length() > 0) {
                    ...
                    h.appConfig.ObtenerFibonnaci(Integer.parseInt(txt2.getText()));
            ...
            private void txt2KeyTyped(KeyEvent e) {
                h.appConfig.solonumeros(e.getKeyChar(), e, txt2.getText(), 2);
            }
        });
        ...
        txt3.addKeyListener(new KeyAdapter() {
            ...
            private void txt3KeyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER && txt3.getText().length() > 0) {
                    ...
                    h.appConfig.proporcionAurea(Double.parseDouble(txt3.getText()));
            ...
            private void txt3KeyTyped(KeyEvent e) {
                h.appConfig.solonumeros(e.getKeyChar(), e, txt3.getText(), 4);
            }
        });
