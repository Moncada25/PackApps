...
public class RompecabezasTabla extends JDialog implements ActionListener, MouseListener {
            ...
            if (opcion != null) {
                ...
                try {
                    ...
                    if (opcion.toString().equals("ID")) {
                        String sql = "select * from rompecabezas where ID ='" + img.cr.ingreseNumero("Ingresa un ID", 6)
                                + "'";
    ...
    public void btnCreateAP() {
        ...
        opcion = JOptionPane.showInputDialog(null, "<html>" + img.cr.styleJOption() + "<strong><em>Seleccionar dificultad</em></strong></html>",
                "Nivel de dificultad", JOptionPane.PLAIN_MESSAGE, null, new Object[]{"Easy", "Medium", "Hard"},
                "Easy");
